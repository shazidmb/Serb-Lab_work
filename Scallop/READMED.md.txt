...
gffread: 
This directory contains the gffread result- All CDS file extracted based on the Miniprot gene location and the Referance file extracted from
Genome Database using samtools.
